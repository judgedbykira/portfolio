...
>On this machine, we are going to exploit the buffer overflow vulnerability in IIS 6.0 **CVE-2017-7269** https://github.com/g0rx/iis6-exploit-2017-CVE-2017-7269/blob/master/iis6%20reverse%20shell
...
>We receive the reverse shell as the user **NT AUTHORITY\network**:
...
>We uploaded the files nc.exe and churrasco.exe via an SMB share on our local machine in order to exploit the **SeImpersonatePrivilege**:
...
>We exploited the token using **churrasco.exe** and gained a shell as **NT AUTHORITY\SYSTEM**:
